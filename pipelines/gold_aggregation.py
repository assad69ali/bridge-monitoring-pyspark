...
def main():
    ...
    Runs Spark Structured Streaming continuously.
    It will keep running until you manually stop the cell in Colab.
    We do NOT call spark.stop(), so gold files remain available.
    """
    spark = (
    ...
    # ----- infer silver schema from static read -----
    # Requires that silver/bridge_temperature already has some data
    ...
    print("Gold streaming started. It will run until you stop the cell in Colab.")
    # Wait on one of the queries to keep the app alive
